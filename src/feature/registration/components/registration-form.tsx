      ...
      <FieldGroup className='mb-6 grid gap-5.5 md:grid-cols-6'>
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid} className='col-span-full gap-1'>
          ...
          render={({ field, fieldState }) => {
            return (
              <Field data-invalid={fieldState.invalid} className='col-span-full gap-1'>
                ...
                <FieldDescription>Pilih jenjang pendidikan terakhir.</FieldDescription>
                {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
              </Field>
            );
          }}
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid} className='gap-1 md:col-span-2'>
              ...
              />
              <FieldDescription>Usia kandungan dalam minggu.</FieldDescription>
              {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
            </Field>
          )}
        />
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid} className='gap-1 md:col-span-2'>
              ...
              />
              <FieldDescription>Usia anak kini (jika sudah lahir).</FieldDescription>
              {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
            </Field>
          )}
        />
